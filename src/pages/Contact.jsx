        ...
        <div className="contact">
          <div className="other">
            <div className="info">
              ...
              <h3>Connect</h3>
              <div className="svg-wrap">
                <a href="http://instagram.com/connorgaunt" target="_blank" rel="noopener noreferrer">
                ...
                <a href="http://twitter.com/connor_gaunt" target="_blank" rel="noopener noreferrer">
                ...
                <a href="http://facebook.com/connorgauntdesign" target="_blank" rel="noopener noreferrer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="60.734"
                    height="60.733"
                ...
                <a href="http://linkedin.com/in/connorgaunt" target="_blank" rel="noopener noreferrer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
